...
timerElement.style.marginTop = '8%';
...
// Start countdown and store the interval ID
const countdown = setInterval(() => {
  if (timeLeft <= 0) {
      clearInterval(countdown);
      timerElement.textContent = "You Lose!";
      timerElement.style.backgroundColor = 'red'; // Change background color on lose
  } else {
      timerElement.textContent = timeLeft;
      timeLeft--;
  }
...
// Add this line to store the countdown ID
let countdownInterval = countdown;
